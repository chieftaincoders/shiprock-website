    ...
    <div class="container">
        ...
        <h3 class="bandh3">Marching Season</h3>
            <p class="bandp">
                ...
                where they perform their Marching songs, and routine. The band plays at competitions, where they perform their show along with,
                competing against other Highschool Marching bands from the district. During marching the band performs asong in the Annual Shiprock
