<h1>JROTC</h1>
    <p>
        JROTC which means, Junior Reserve Officer Training Corps, is where students are able to see what it would be like
        if they plan to join the military.
    </p>

<h2>Drill Team</h2>
    <p>
        Drill team is where the students, practice drills throughout the month with physical training at least once a week.
        Depending on their performance throughout the month, students can go to drill meets where they perform drills.
...
<h2>Events</h2>
    <p>
        ...
        entering from the exit they had left. A hard physical training called the CFT, which is Combat Fitness Test, which
